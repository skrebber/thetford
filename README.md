# CI-Bus interface for Thetford fridges

This code was cloned from https://github.com/horchi/linux-homectld/tree/master/thetford. Thanks horchi for your incredible work!

Because the used MQTT format was not suitable for me, I changed it to my needs.
I like better the idea of having a topic and as its value returning an json containing objects with object-name and its value. 

For example: 
mqtt topic: thetford/T2000/IntSupply
json: {"byte": 128, "value": 12.8, "unit": "V"}

continuing the original readme.md:
